  ...
  return {
    ...
    async create(ctx, next) {
      ...
      return await strapi.entityService
        .update('api::task.task', response.data.id, {data: {author: id}});
    },
    ...
    async update(ctx, next) {
      ...
      return await strapi.entityService
        .update('api::task.task', taskId, {data: {author: id}});
    },
    ...
    async delete(ctx, next) {
      ...
      return await strapi.entityService
        .delete('api::task.task', taskId, {data: {author: id}});
    },
    ...
    async findOne(ctx, next) {
      ...
      return await strapi.entityService
        .findOne('api::task.task', taskId, {data: {author: id}});
    }
  }
});
